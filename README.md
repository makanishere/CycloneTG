...
git clone https://github.com/MakanIsHere/CycloneTG.git
cd CycloneTG
./launch.sh install
...
```bash
sudo apt-get update && sudo apt-get upgrade -y && sudo apt-get autoremove && sudo apt-get autoclean && sudo apt-get install libreadline-dev libconfig-dev libssl-dev lua5.2 liblua5.2-dev libevent-dev make unzip git redis-server g++ libjansson-dev libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf DBTeam && rm -rf .telegram-cli && git clone https://github.com/MakanIsHere/CycloneTG.git && cd CycloneTG && ./launch.sh install && ./launch.sh
```
...
CycloneTeam developers
-----------------

@Makan & @SHAHZADEH_UNISON

CycloneTeam support channels
-----------------------
